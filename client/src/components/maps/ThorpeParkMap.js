      ...
      <div id='map'>
        <div id='attractionsAndFacilities'>
          ...
          <div ref="Colossus" id="colossus" className="ride" onClick={() => this.toggleRideInfo("Colossus")}>
            <img src={require('.././images/colossus.jpg')} />
          </div>
